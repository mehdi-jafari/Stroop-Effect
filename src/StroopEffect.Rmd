...
Null hypotheses = mean of the time that takes for participants to say the words
by applying incongruent treatment is equal to congruent condition's µi = µ0 

Alternative hypotheses = mean the time that takes for participants to say the 
words by applying incongruent treatment is greater than congruent condition's
µi > µ0
